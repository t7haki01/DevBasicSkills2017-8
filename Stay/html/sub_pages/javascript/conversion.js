...
function value_number()
{
    ...
    {
        user_input.value = "" ; // After User test(beta), else for decimal value is setted
    }                           // until test, other number system's prefix remains, so it was error
}
...
function filter(event)
{
    ...
    if( number_value.value == "octal" )
    {
        ...
        {
            alert("In octal number system, input is allowed only number from 0 to 7." + 
                  "\nPlease, give only valid input.") ;
            event.preventDefault();
        }
    ...
    if( number_value.value == "hexadecimal" )
    {
        ...
        {
            alert("In hexadecimal number system, input is allowed only number from 0 to f." + 
                  "\nPlease, give only valid input.") ;
            event.preventDefault();
        }
    ...
    if( number_value.value == "decimal" )
    {
        if( number_input_user < 0 )
        {
            alert("In decimal number system, input is allowed only number from 0 to 9." + 
                  "\nPlease, give only valid input.") ;
            event.preventDefault();
        }
